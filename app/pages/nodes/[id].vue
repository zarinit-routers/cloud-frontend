...
const presetCommands = ["v1/timezone/get", "v1/timezone/set", "v1/system/get-os-info", "v1/system/get-device-info", "v1/ssh/get-status", "v1/ssh/enable", "v1/ssh/disable", "v1/system/reboot"];
